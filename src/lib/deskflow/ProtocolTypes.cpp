...
const char *const kMsgDDragInfo = "DDRG%2i%4i%4i%4i%s";
const char *const kMsgDFileTransferMeta = "DFTM%4i%4i%4i%4i%1i%s";
const char *const kMsgQDropTargetInfo = "QDTI%4i%1i%s";
const char *const kMsgQDropTargetInfoQuery = "QDTQ%4i%2i%2i";
const char *const kMsgQDragCancel = "QDGX%4i%1i";
const char *const kMsgDFileTransferProgress = "DFPR%4i%4i%4i%4i%4i";
